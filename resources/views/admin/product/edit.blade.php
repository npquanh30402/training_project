...
@section('content')
    <div class="card">
        ...
        <div class="row">
            <img class="img-pro" src="{{ asset('/storage/img/products/' . $viewData['product']->getImage()) }}" alt="...">
            ...
            <form class="add-product" action="{{ route('admin.product.update', ['id' => $viewData['product']->getId()]) }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="{{ $viewData['product']->getBrand() }}" class="form-control"
                        name="brand">
                </div>
                <div class="mb-3">
                    <label for="price" class="form-label">Giá:</label>
                    <input type="text" value="{{ $viewData['product']->getPrice() }}" class="form-control"
                        name="price">
                </div>
                <div class="mb-3">
